...
const CryptoTracker = () => {
  ...
  // yha se ui start
  const Navigation = () => (
    <nav className="bg-gray-900/80 backdrop-blur-sm text-white shadow-md p-4 sticky top-0 z-20 w-full border-b border-gray-800">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4 gap-4">
          <h1 className="text-3xl font-semibold tracking-tight">CripTik</h1>
          <button
            onClick={fetchCryptoData}
            className="flex items-center gap-2 bg-blue-600 hover:bg-blue-700 px-4 py-2 rounded-full transition-all shadow-sm hover:shadow-md text-sm font-medium"
          >
            <RefreshCw size={16} />
            <span className="hidden sm:inline">Refresh</span>
          </button>
        </div>
        <div className="flex flex-wrap gap-2 sm:gap-4 overflow-x-auto pb-1">
          {[
            ...
            <button
              ...
              className={`flex items-center gap-2 px-4 py-2 rounded-full text-sm font-medium transition-all whitespace-nowrap shadow-sm ${
                activeTab === id
