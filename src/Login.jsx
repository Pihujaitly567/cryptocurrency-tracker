...
const Login = ({ onLogin }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Simulate login process (since no backend)
    setTimeout(() => {
      setIsLoading(false);
      onLogin();
    }, 1000);
      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          ...
          <p className="text-gray-300">
            Sign in to your Crypto Tracker account
          </p>
        </div>
        ...
        <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 shadow-2xl border border-white/20">
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              <button className="w-full inline-flex justify-center py-2 px-4 border border-gray-600 rounded-xl shadow-sm bg-white/5 text-sm font-medium text-gray-300 hover:bg-white/10 transition-all duration-200">
